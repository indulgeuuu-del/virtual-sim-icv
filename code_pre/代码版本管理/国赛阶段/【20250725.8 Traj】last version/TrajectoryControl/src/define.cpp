...
float achieveThres = 5.0f;
float chasingLimitDist = 10.f;
float followingLimitSpeed = 3.5f;
...
FeatureSwitcher mobileSingleStoplineSwitcher; // 移动半停止线变道功能开关
std::vector<ManualStopLineReservoir> manualStopLineReservoir;
std::vector<StrategyPoint> strategyPoint; // 策略点
std::vector<std::tuple<SSD::SimPoint3D, SSD::SimPoint3D>> slideConfig; // 溜车配置
